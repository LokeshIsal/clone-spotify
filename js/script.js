console.log('Lets right javaSript');
...
async function getSongs(folder) {
    ...
    let response = await a.text("/songs/");
    ...
    for (const song of songs) {
        songUL.innerHTML = songUL.innerHTML + `<li>
                               <img class="invert" width = "34px" src="music.svg" alt="">
                            <div class="info">
                            ...
                            <div class="playnow">
                                <span>Play Now</span>
                                <img width="42px" class="invert" src="play.svg" alt="">
                            </div>
                        </li> `
    }
...
async function main() {
    ...
    // add event listner for mute the track
